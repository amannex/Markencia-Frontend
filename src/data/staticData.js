...
export const WORKS = [
  // { title: 'Markencia Brand Identity', link: 'https://markencia.com', category: 'Brand Identity', gradient: 'linear-gradient(135deg, #003818, #FFB400)', image: 'https://images.unsplash.com/photo-1542744173-8e7e53415bb0?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80', content: 'A complete brand overhaul for Markencia, defining core values and visual identity for future growth.', isLarge: true, isFeatured: true },
  // { title: 'SaaS Landing Page Funnel', link: 'https://example.com', category: 'Web Design', gradient: 'linear-gradient(135deg, #0f172a, #334155)', image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80', content: 'Designed a high-converting SaaS landing page with optimized user flows and clear calls to action.', isFeatured: true },
  // { title: 'AI Chatbot UI/UX', link: 'https://example.com', category: 'AI Automation', gradient: 'linear-gradient(135deg, #FFB400, #ff6b35)', image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80', content: 'Created an intuitive user interface for an advanced AI chatbot, ensuring a seamless user experience.', isFeatured: true },
  // { title: 'E-commerce Conversion Redesign', link: 'https://example.com', category: 'Web Design', gradient: 'linear-gradient(135deg, #475569, #0f172a)', image: 'https://images.unsplash.com/photo-1556761175-5973dc0f32d7?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80', content: 'Revamped the e-commerce checkout process, reducing cart abandonment and increasing sales by 25%.', isLarge: true },
